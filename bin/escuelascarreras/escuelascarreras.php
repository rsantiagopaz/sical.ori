...
switch ($_REQUEST['rutina'])
{
	case 'insert': 
	{
		...
		$sql.="AND id_carrera='".$xml_Escuela["id_carrera"]."' ";
		$sql.="AND id_espacio='".$xml_Escuela["id_espacio"]."' ";
		...
		{	
			...
			if($row['cc1']!=0) {
				...
				$sql="INSERT escuelas_carreras_espacios SET id_escuela = '".$xml_Escuela["id_escuela"]."', cod_escuela = '".$xml_Escuela["cod_escuela"]."', " .
					"id_carrera='".$xml_Escuela["id_carrera"]."', cod_carrera='".$xml_Escuela['cod_carrera']."', " .
					"id_espacio='".$xml_Escuela["id_espacio"]."', cod_espacio='".$xml_Escuela['cod_espacio']."'";		
				toXML($xml, $sql, "add");
   ...
   case 'traer_carreras_espacios':
 	{ 	 		
		$xml=new SimpleXMLElement('<rows/>');
	  	$sql="SELECT id_escuela_carrera_espacio, id_carrera, ca.codigo 'cod_carrera', id_espacio, esp.codigo 'cod_espacio', nombre, denominacion, n.id_nivel 'id_nivel', 'A' as origen ";
		$sql.="FROM escuelas_carreras_espacios ";
		$sql.="INNER JOIN carreras ca USING(id_carrera) ";
		$sql.="INNER JOIN espacios esp USING(id_espacio) ";
