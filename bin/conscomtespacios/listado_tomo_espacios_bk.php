...
switch ($_REQUEST['rutina'])
{
	case 'tomo_espacios':
	{
		...
		$objPHPExcel->getProperties()->setCreator("SiCal")
						 ...
						 ->setTitle("Tomo Espacios")
						 ->setSubject("Tomo Espacios");
		...
		$objPHPExcel->getActiveSheet()->setCellValue('A2', 'Espacios por Título');
		...
		$objPHPExcel->setActiveSheetIndex(0)
							->setCellValue('A' . $i,'Carrera')
							->setCellValue('B' . $i,'Espacio')
		...
		// Rename sheet
		$objPHPExcel->getActiveSheet()->setTitle('Tomo Espacios');
