...
package paquete01
{
   ...
   // ------------------------------------------------------------
	public class ControlAcceso
	{
		...
		private var _usuario_nivel_id : String;
        ...
        private function httpsLoginResult(e:Event):void
         {
         	...
         	if (error.length > 0)
		       ...
		       _sistema_id             = httpsLogin.lastResult.ControlAcceso._sistema_id;
	 	       ...
	 	       _usuario_nivel_id   = httpsLogin.lastResult.ControlAcceso._usuario_nivel_id;
        ...
        public function login(usuario:String, password:String, sistema_id:String) : void
         {
         	 _usuario    = usuario;
         	 _password   = password;
		...
		public function get getUsuarioOrganismoId() : String
		 ...
		 public function get getUsuarioNivelId() : String
		 {
		 	return _usuario_nivel_id;
		 } 
